            ...
            <Row>
                <Col className={s.filter}>
                    <ButtonGroup aria-label="Basic example" className={s.btns}>
                        <Button variant="secondary" onClick={()=>todoFilter('all')}>Всі</Button>
                        <Button variant="secondary" onClick={()=>todoFilter(true)}>Невиконані</Button>
                        <Button variant="secondary" onClick={()=>todoFilter(false)}>Виконані</Button>
                    </ButtonGroup>
                </Col>
            </Row>
